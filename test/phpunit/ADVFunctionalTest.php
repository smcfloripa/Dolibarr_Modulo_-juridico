...
/**
 * \file    test/phpunit/ADVFunctionalTest.php
 * \ingroup adv
 ...
 * @package Testadv
 */
class ADVFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/adv/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('adv/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/adv/admin/about.php');
		$this->authenticate();
		return $this->assertContains('adv/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('advwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modADV_ADVTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modADV_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
