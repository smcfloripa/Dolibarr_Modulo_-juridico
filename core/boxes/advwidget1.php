...
/**
 * \file    adv/core/boxes/advwidget1.php
 * \ingroup adv
 * \brief   Widget provided by ADV
 *
 ...
 */
class advwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "advbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "adv@adv";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->adv->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/adv/class/adv.class.php");

		// Populate the head at runtime
		$text = $langs->trans("ADVBoxDescription", $max);
